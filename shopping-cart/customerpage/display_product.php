...
<?php
	...
	$query = "SELECT r.rest_name, r.rest_pic_file, p.product_name,p.product_category, p.product_price, p.product_pic_path, p.product_id, r.rest_id
